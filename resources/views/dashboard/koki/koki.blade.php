 ...
 <main class="  welcome  w-100 " >
  <div class="container-fluid">
    <div class="rps row">
      ...
      <h1 class="tulisan"><br><br>CHEF TIME</h1>
      ...
      <div class=" open card card body"> Open: 
        ...
        <script >
         ...
         <div  class=" open card card body"> DATE:<br>
            <script type='text/javascript' font-size: 18px; >
          ...
          <div class="row">
              ...
              <table class="table table-striped table-sm">
                  ...
                  <tbody>
                      ...
                      <tr class="font1">
                          <td class="font1">{{ $order->nama_menu }}</td>
                          <td class="font1">{{ $order->qty}}</td>
                          <td> 
                              <a href="/ready/{{ $order->id }}" class="btn btn-danger">Ready</a>
                            </td>
                        </tr>
